import { z } from 'zod';
import { SaleDetailSchema } from './create-sale.dto';
...
/**
 * Mêmes champs que CreateSaleSchema, tous optionnels — n'est autorisé côté service
 * que si la vente est encore au statut PENDING (§17 point 7 : un document COMPLETED
 * ou CANCELLED est immuable).
 */
