...
/** Paiement encaissé sur un achat fournisseur (S25 — mirror de CreatePaymentSchema/ventes, §18.7). */
export const CreatePaymentSchema = z.object({
  ...
  /** Monnaie rendue au fournisseur — string décimale, facultatif (défaut "0"). */
